...
logo = """
   Asif Javed
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS umarkhan TRICKER 
   THE LEGEND ℒℴνℯ
...
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/umarkhan102/love
\033[1;96mBlogger \033[1;93m: \033[1;92mhttps://www.facebook.com/umarkhan
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "umarkhan"
CorrectPassword = "03155331110"
loop = 'true'
while (loop == 'true'):
